...
<div class="container-fluid">
    <h1 class="mb-4"><i class="fas fa-user-edit"></i> Editar Usuario</h1>

    <div class="card shadow-lg">
        <div class="card-body">
            <form action="{{ route('admin.usuarios.update', $usuario->dni) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="semestre" id="semestre" class="form-control" value="{{ $usuario->semestre }}">
                </div>

                <div class="mb-3">
                    <label for="turno" class="form-label">Turno</label>
                    <select name="turno" id="turno" class="form-select">
                        <option value="MAÑANA" @selected($usuario->turno == 'MAÑANA')>Mañana</option>
                        <option value="NOCHE" @selected($usuario->turno == 'NOCHE')>Noche</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="estado" id="estado" class="form-select">
                        ...
                        <option value="SANCIONADO" @selected($usuario->estado == 'SANCIONADO')>Sancionado</option>
                    </select>
                </div>

                <button class="btn btn-primary"><i class="fas fa-save"></i> Actualizar Usuario</button>
            </form>
        </div>
    </div>
</div>
